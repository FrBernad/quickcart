...
# #     monkeypatch.setattr(users_api, "get_user_by_email", mock_get_user_by_email)
# #     monkeypatch.setattr(users_api, "add_user", mock_add_user)
...
#     monkeypatch.setattr(users_api, "get_user_by_id", mock_get_user_by_id)
#     client = test_app.test_client()
...
# #     monkeypatch.setattr(users_api, "get_all_users", mock_get_all_users)
# #     client = test_app.test_client()
...
# #     monkeypatch.setattr(users_api, "get_user_by_id", mock_get_user_by_id)
# #     monkeypatch.setattr(users_api, "delete_user", mock_delete_user)
# #     client = test_app.test_client()
...
# #     monkeypatch.setattr(users_api, "get_user_by_id", mock_get_user_by_id)
# #     monkeypatch.setattr(users_api, "get_user_by_email", mock_get_user_by_email)
# #     monkeypatch.setattr(users_api, "update_user", mock_update_user)

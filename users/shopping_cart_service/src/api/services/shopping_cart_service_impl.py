...
class ShoppingCartServiceImpl(ShoppingCartService):
    ...
    def get_products(self, user_id):
        ...
        shopping_cart_detailed = self.__fill_shopping_cart_with_products_info(shopping_cart)
    ...
    def __decrease_stock_product_by_id(self, product_id, quantity,
                                        current_stock):
    ...
    def __create_purchase_order(self, user_id, shopping_cart_products_map, products_details_map,comments,payment_info):
